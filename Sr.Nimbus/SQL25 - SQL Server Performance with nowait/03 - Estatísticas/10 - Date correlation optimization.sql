...
SELECT Pedidos.PedidoID, 
 ...
 WHERE Pedidos.DataPedido BETWEEN '20150601' AND '20150605'
OPTION (RECOMPILE)
...
SELECT * 
 ...
 INNER JOIN Item_Pedidos
    ON Item_Pedidos.PedidoID = Pedidos.PedidoID 
 WHERE Pedidos.DataPedido = '20150603'
...
SELECT datediff(day,CONVERT(datetime,'1900-01-01 00:00:00.000',121),
                    CONVERT(datetime,'2015-06-03 00:00:00.000',121)) / (30)
GO

SELECT *
  FROM vw_Test
 WHERE ParentPID = 1405
GO

-- Com os valores de 1373 e 1374 em mãos o SQL aplica a regra inversa 
-- para poder obter os valores do filtro por DataEntrega.
SELECT CONVERT(DateTime, '19000101') + (1405 * 30)
SELECT CONVERT(DateTime, '19000101') + ((1406  + 1) * 30)

-- Traduzindo, a partir de 1900-01-01 some (1345 * 30), 
-- neste caso teremos o valor de 2012-10-10 como valor mínimo
