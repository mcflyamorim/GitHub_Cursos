...
SELECT * 
 ...
 WHERE IsNumeric(Col1) = 1
   AND Col1 <= 10
OPTION (QueryTraceON 9130) -- TF 9130 para mostrar o operador de Filter no lugar de predicate no scan

/*
  Observação, cuidado com IsNumeric:
...
/*
  Caso onde podemos ver que nem sempre o CASE garante a ordem das consultas
