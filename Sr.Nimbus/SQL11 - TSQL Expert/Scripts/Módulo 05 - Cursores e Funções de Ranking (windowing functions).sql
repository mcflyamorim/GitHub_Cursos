...
DECLARE @c1 int, @c2 int, @c3 money, @c4 smallint, @c5 real
DECLARE C 
 CURSOR FOR 
 SELECT *
   FROM Order_Details
...
DECLARE @tabela 
  TABLE (c1 int, c2 int, c3 money, c4 smallint, c5 real)

OPEN C

FETCH NEXT FROM C INTO @c1, @c2, @c3, @c4, @c5
WHILE @@FETCH_STATUS = 0
BEGIN
 	INSERT INTO @tabela VALUES (@c1, @c2, @c3, @c4, @c5)
	 FETCH NEXT FROM C INTO @c1, @c2, @c3, @c4, @c5
END
...
-- Monitorar no profiler
SET NOCOUNT ON
DECLARE cCursor CURSOR DYNAMIC
