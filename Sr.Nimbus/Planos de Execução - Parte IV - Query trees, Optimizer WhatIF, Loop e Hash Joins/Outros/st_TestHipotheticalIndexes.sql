...
END
GO
CREATE ASSEMBLY CLR_ProjectAutoPilot FROM 'D:\Fabiano\Trabalho\Sr.Nimbus\Cursos\OnDemand\Planos de Execução - Parte IV - Query trees, Optimizer WhatIF, Loop e Hash Joins\Outros\ProjectAutoPilot\ProjectAutoPilot\bin\Release\ProjectAutoPilot.dll' WITH PERMISSION_SET = SAFE
GO
