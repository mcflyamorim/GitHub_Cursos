...
CREATE DATABASE [DBTestCosts]
 ON  PRIMARY 
( NAME = N'DBTestCosts', FILENAME = N'E:\Temp\DBTestCosts.mdf' , SIZE = 1048576KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DBTestCosts_log', FILENAME = N'E:\Temp\DBTestCosts_log.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
