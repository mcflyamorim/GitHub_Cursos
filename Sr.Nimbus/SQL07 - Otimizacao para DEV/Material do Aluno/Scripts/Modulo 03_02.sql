...
INSERT INTO Teste VALUES ('Maria Aparecida')
SELECT @@TRANCOUNT
COMMIT
...
-- Nested
BEGIN TRANSACTION
INSERT INTO Teste VALUES ('Joao José 2')
SELECT @@TRANCOUNT
	BEGIN TRANSACTION
	INSERT INTO Teste VALUES ('Joao José 3')
	SELECT @@TRANCOUNT
ROLLBACK
SELECT @@TRANCOUNT
go
...
BEGIN TRANSACTION
INSERT INTO Teste VALUES ('Joao José 4')
SELECT @@TRANCOUNT
SAVE TRANSACTION Segmento01
INSERT INTO Teste VALUES ('Joao José 5')
SELECT @@TRANCOUNT
...
from dbo.t1
where %%lockres%% = '(020068e8b274)'
*/

/*
	Author: Luciano Caixeta Moreira
	Date: 02/25/2008
	Description: Shows how to use the snapshot isolation level and how to differentiate between statement/transaction
		level consistency.
*/
USE Master
GO
