...
END
GO
CREATE ASSEMBLY CLR_ProjectAutoPilot FROM 'C:\Fabiano\Trabalho\Sr.Nimbus\Cursos\Treinamento tuning SQL Server\Scripts\Scripts to Create NorthWind DB\ProjectAutoPilot\ProjectAutoPilot\bin\Release\ProjectAutoPilot.dll' WITH PERMISSION_SET = SAFE
GO
