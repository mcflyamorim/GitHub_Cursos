...
---- Criando um índice hipotético sem estatística
---- DROP INDEX OrdersBig.ix_OrderDate_Hipotetico_Sem_Statistica 
--CREATE INDEX ix_OrderDate_Hipotetico_Sem_Statistica ON OrdersBig(OrderDate) WITH STATISTICS_ONLY = -2
--GO
...
-- Custo da consulta sem o índice = 4,21513
...
DBCC AUTOPILOT (0, 7, 1637580872, 1) -- Índice cluster
DBCC AUTOPILOT (0, 7, 1637580872, 3) -- Índice ix_OrderDate_Hipotetico
GO
SET AUTOPILOT ON
GO
SELECT *
