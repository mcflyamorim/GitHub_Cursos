...
-- Table 'Cadastro_Clientes'. Scan count 1, logical reads 923, physical reads 3
...
-- Table 'Cadastro_Clientes'. Scan count 1, logical reads 539
GO


ALTER TABLE Cadastro_Clientes DROP CONSTRAINT XPK_Cadastro_Clientes
GO
CREATE CLUSTERED COLUMNSTORE INDEX ix1 ON Cadastro_Clientes
WITH(DATA_COMPRESSION = COLUMNSTORE_ARCHIVE )
GO

--DATA_COMPRESSION = COLUMNSTORE | COLUMNSTORE_ARCHIVE
--Applies to: SQL Server 2016 through SQL Server 2017. Specifies the data compression option for the specified table, partition number, or range of partitions. The options are as follows:
--COLUMNSTORE
