USE Northwind
GO
DROP PROC IF EXISTS st_QueryCostAlto
GO

CREATE PROC st_QueryCostAlto @Var VARCHAR(200)
AS

SELECT Orders.OrderID, COUNT(DISTINCT Orders.CustomerID), SUM(Orders.Value) 
