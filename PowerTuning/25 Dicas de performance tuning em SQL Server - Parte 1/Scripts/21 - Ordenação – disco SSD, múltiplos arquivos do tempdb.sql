...
USE [master];
GO
-- ADD another file on E: drive
ALTER DATABASE [tempdb] ADD FILE (NAME = N'tempdev2', FILENAME = N'E:\Temp\Data_Tempdb_SQL2017_2.ndf' , SIZE = 1GB , FILEGROWTH = 25MB);
GO
...
-- Como ficam as escritas em um SSD? ...  SSD 2 arquivos em discos diferentes...
