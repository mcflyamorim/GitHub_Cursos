...
END
GO
CREATE ASSEMBLY Assembly_PADL FROM 'C:\Fabiano\Trabalho\Sr.Nimbus\Cursos\SQL11 - TSQL Expert\Scripts\CLR Functions\PADL\PADL\bin\Debug\PADL.dll' WITH PERMISSION_SET = SAFE
GO
